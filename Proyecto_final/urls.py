...
urlpatterns = [
    ...
    path('propiedad/list', PropiedadList.as_view(), name ="propiedad-list"),
    path('propiedad/list', PropiedadMineList.as_view(), name ="propiedad-mine"),
    ...
    path('mensaje/<pk>/create', MensajeCreate.as_view(), name= "mensaje-create"),
